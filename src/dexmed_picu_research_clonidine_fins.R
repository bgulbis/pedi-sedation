...
fins <- read_excel("U:/Data/pedi_sedation/tidy/dexmed_clonidine_fins.xlsx")

mbo_fins <- edwr::concat_encounters(fins$FIN)
print(mbo_fins)

dir_data <- "U:/Data/pedi_sedation/tidy/dexmed_picu_clonidine"
...
data_demographics <- get_data("clon_fin_demographics.csv")

df_dexmed <- get_data("clon_fin_rates.csv")

df_meds <- get_data("clon_fin_meds.csv")

df_locations <- get_data("clon_fin_locations.csv") 

df_vent_times <- get_data("clon_fin_vent_times.csv") 

df_vent_events <- get_data("clon_fin_vent_events.csv") 
...
write.xlsx(l, "U:/Data/pedi_sedation/final/dexmed_picu_clonidine.xlsx")
