...
meds_capd %>%
    ...
    knitr::kable(digits = 1, caption = "Distribution of infusion rates by medication")
...
meds_capd_sum %>%
    ...
    knitr::kable(digits = 1, caption = "Distribution of time-weighted average infusion rates by medication")
